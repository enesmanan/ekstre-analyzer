...
| 2 | [faz-2-extraction-sqlite.md](phases/faz-2-extraction-sqlite.md) | Gemini çıkarım, doğrulama katmanı, SQLite | 1,5 hafta | bitti |
| 3 | [faz-3-dashboard.md](phases/faz-3-dashboard.md) | HTTP API + React dashboard | 3 hafta | bitti |
...
Sonraki adım: [Faz 3.5 görev listesi](phases/faz-3.5-ai-advice.md#6-görevler) — §3 ön koşulları çalıştır, F35-T01'den başla.

## Changelog

- 2026-09-16 v2 onaylı
- 2026-09-16 Faz 3 `bitti`; sonraki adım Faz 3.5
